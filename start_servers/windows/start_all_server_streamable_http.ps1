...
# List of servers
$servers = @(
    @{ Path="../../challenges/easy/challenge1/server_streamable_http.py"; Port=9001 },
    @{ Path="../../challenges/easy/challenge2/server_streamable_http.py"; Port=9002 },
    @{ Path="../../challenges/easy/challenge3/server_streamable_http.py"; Port=9003 },
    @{ Path="../../challenges/medium/challenge4/server_streamable_http.py"; Port=9004 },
    @{ Path="../../challenges/medium/challenge5/server_streamable_http.py"; Port=9005 },
    @{ Path="../../challenges/medium/challenge6/server_streamable_http.py"; Port=9006 },
    @{ Path="../../challenges/medium/challenge7/server_streamable_http.py"; Port=9007 },
    @{ Path="../../challenges/hard/challenge8/server_streamable_http.py"; Port=9008 },
    @{ Path="../../challenges/hard/challenge9/server_streamable_http.py"; Port=9009 },
    @{ Path="../../challenges/hard/challenge10/server_streamable_http.py"; Port=9010 }
)
